...
class SpeakerDaoTest {
    ...
    @Test
    fun `test speakerDao fetches all speakers`() = runTest {
    ...
    @Test
    fun `test getNames returns all names`() = runTest {
    ...
    @Test
    fun `test deleteByNames deletes specified speakers`() = runTest {
        speakerDao.insert(createSpeaker(id = 1, name = "Name 1"))
        speakerDao.insert(createSpeaker(id = 2, name = "Name 2"))
    ...
    private fun createSpeaker(id: Int, name: String) = SpeakerEntity(
        id = id,
        name = name,
        tagline = "Tagline",
        bio = "Bio",
