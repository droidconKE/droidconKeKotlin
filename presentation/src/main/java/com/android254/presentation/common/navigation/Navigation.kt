...
fun Navigation(
    ...
    NavHost(navController, startDestination = Screens.Home.route) {
        ...
        composable(
            ...
            arguments =
                listOf(
                    navArgument(Screens.SessionDetails.SESSION_ID_NAVIGATION_ARGUMENT) {
            ...
            SessionDetailsRoute(
                sessionId = requireNotNull(backStackEntry.arguments?.getString(Screens.SessionDetails.SESSION_ID_NAVIGATION_ARGUMENT)),
